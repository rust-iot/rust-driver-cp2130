...
use rusb::{Device as UsbDevice, Context, DeviceDescriptor, DeviceHandle, Direction, TransferType};
...
impl Inner {
    ...
    pub fn new(device: UsbDevice<Context>, descriptor: DeviceDescriptor) -> Result<(Self, Info), Error> {
