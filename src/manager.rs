...
pub use rusb::{Device as UsbDevice, Context, UsbContext, DeviceList, DeviceDescriptor};
...
impl Manager {
    ...
    pub fn devices() -> Result<DeviceList<Context>, Error> {
    ...
    pub fn devices_filtered(filter: Filter) -> Result<Vec<(UsbDevice<Context>, DeviceDescriptor)>, Error> {
    ...
    pub fn device(filter: Filter, index: usize) -> Result<(UsbDevice<Context>, DeviceDescriptor), Error> {
